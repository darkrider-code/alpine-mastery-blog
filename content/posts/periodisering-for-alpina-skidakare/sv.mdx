...
<<<<<<< HEAD
<<<<<<< HEAD
description: "Komplett guide till periodisering för alpina skidåkare – från off-season i maj till in-season i januari, vecka för vecka."
...
- Reaktiv styrka och RSI (hopp, landningar, snabb
a riktningsförändringar)
...
Alpine Masterys barmarksmodul tar din videoanalys som startpunkt och genererar ett periodiserat träni
ngsprogram.
