...
Balance in slalom is dynamic, not static. At the entry of the turn, the center
 of mass is often slightly forward to help the ski enter the right path. As you build pressure through the apex, you can let the body center over the ski again without blocking the movement. At the exit, you reduce STEOUT so that you don't brake into the next turn.
...
| Hasty transition | Short edge 
grip, jerky skiing | Count tempo: let the turn "breathe" before changing |
