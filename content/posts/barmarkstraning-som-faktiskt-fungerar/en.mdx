...
<<<<<<< HEAD
<<<<<<< HEAD
description: "How to structure your off-season training for maximum performance gains – based on research on HIIT, strength, and periodization for alpine skiers."
...
Lateral jumps with short contact time
, rotational jumps, single-leg exercises, plank with rotation, single-leg squat with eccentric control.
