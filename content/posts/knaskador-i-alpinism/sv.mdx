...
<<<<<<< HEAD
<<<<<<< HEAD
description: "Lär dig mekanismen bakom de vanligaste knäskadorna i alpinism och hur du förebygger dem med rätt träning och teknik."
...
Videoanalys av skadade åkare visar att vissa 
rörelsemönster ofta föregår en ACL‑skada:
